try {
    ...
    */
    ...
    // Total Revenue
    d_1C_R = new ApexCharts(document.querySelector("#total-revenue"), sparkRevenue);
    d_1C_R.render();

    // Total Orders
    d_1C_O = new ApexCharts(document.querySelector("#total-orders1"), sparkOrders);
    d_1C_O.render();
    
    // Total Visits
    d_1C_V = new ApexCharts(document.querySelector("#total-visits"), sparkVisistors);
    d_1C_V.render();

    // Total Conversations
    d_1C_C = new ApexCharts(document.querySelector("#total-conversations"), sparkConversations);
    d_1C_C.render();
    ...
    */
    ...
    var d_1C_5 = new ApexCharts(document.querySelector("#hybrid_followers"), d_1options6);
    d_1C_5.render()
    
    // Followers

    var d_1C_5 = new ApexCharts(document.querySelector("#hybrid_followers2"), d_1options3);
    d_1C_5.render()
...
var chartVisits = new ApexCharts(
    document.querySelector("#visitsMonthly"),
    optionVisitors
);
